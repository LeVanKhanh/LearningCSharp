namespace CSharp8
{
    public static class TestName
    {
        ...
        public const string SWITCH_EXPRESSIONS = "Switch_Expressions";
        public const string PROPERTY_PATTERNS = "Property_Patterns";
        public const string TUPLE_PATTERNS = "Tuple_Patterns";
